...
#ifndef __SDIO_FUNCTION_H
#define __SDIO_FUNCTION_H
...
/**
  * @} user denfine 
  */
#define SDIO_FIFO_ADDRESS                ((uint32_t)0x40018080)	 //SDIO_FIFOADDR = SDIOBASEADDR+0x80 -> SDIOBASEADDR+0xfc
/** 
